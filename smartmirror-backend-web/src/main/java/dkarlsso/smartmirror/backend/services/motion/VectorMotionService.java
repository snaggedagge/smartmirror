...
/**
 * Service for detecting hand gestures/movements
 * The idea was to implement a vector (math kind of vector) type of service. I quickly realised that i could only get
 * like 2-4 different captures of a hand in a swipe, so there was not enough data to make it work properly
 */
@Service
