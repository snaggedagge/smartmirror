...
# *DEPRECATED*
Below is description of old app, which ran JavaFX for GUI. 
This has now been turned into a spring boot application with APIs, 
consumed by an Angular powered Electron app for frontend


Remnants of horrible stuff can be seen in this project.
